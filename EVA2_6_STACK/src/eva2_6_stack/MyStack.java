...
//                System.out.println("el valor en la posicion "+posicion+" inversamente es: "+temp2.getValor());
    ...
    //agrega un nodo a la pila STACK
    public void push(int valor) {
        add(valor);
    }

    //POP: recupera un valor de la estructura STACK
    //elmimina el ultimo nodo
    public int pop() throws Exception {
//        if(previo==null){
        int valor = fin.getValor();
//        int valor = size();
//int valor = findKth(fin.getValor());
//        eliminar(fin.getValor());
    ...
    //PEEK: recupera un valor de la estructura (STACK)
